...
class EbayAPIService: RetailerAPIService {
    ...
    private let browseBaseURL = "https://api.ebay.com/buy/browse/v1"
    private let feedBaseURL = "https://api.ebay.com/buy/feed/v1"
    private let notificationBaseURL = "https://api.ebay.com/commerce/notification/v1"
    ...
    private let webhookServerURL = "https://rasuto-notifications.example.com/ebay/webhook"
    ...
    init(apiKey: String, notificationManager: EbayNotificationManager) {
        self.apiKey = apiKey
        ...
        // Get or create the verification token
           ...
           private func mapToProductItemDTO(_ ebayItem: EbayItemSummary) -> ProductItemDTO {
               ...
               return ProductItemDTO(
                   ...
                   imageUrls: imageUrls,
                   thumbnailUrl: ebayItem.thumbnailImages?.first?.imageUrl ?? ebayItem.image?.imageUrl,
